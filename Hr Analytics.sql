...
SELECT REPLACE(Employee_Name,SUBSTR(Employee_Name,INSTR(Employee_Name,',')),'') FROM records;
UPDATE records SET Employee_Name = REPLACE(Employee_Name,SUBSTR(Employee_Name,INSTR(Employee_Name,',')),'');
